...
$consulta1="SELECT * FROM pedidocolchon WHERE Id_Cliente='{$id_Cliente}' AND Id_Negocio='{$id_Negocio}' AND Estado_PedidoCol ='r';";
mysqli_set_charset($conexion, "utf8");
...
$consulta2="SELECT * FROM pedidosillon WHERE Id_Cliente='{$id_Cliente}' AND Id_Negocio='{$id_Negocio}' AND Estado_PedidoSillon ='r';";
mysqli_set_charset($conexion, "utf8");
