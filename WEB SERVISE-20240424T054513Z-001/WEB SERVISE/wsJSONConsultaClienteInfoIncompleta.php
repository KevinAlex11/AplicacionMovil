...
$consulta="SELECT * FROM pedidoauto WHERE Estado_PedidoAuto ='i';";
...
$consulta1="SELECT * FROM pedidocolchon WHERE Estado_PedidoCol ='i';";
mysqli_set_charset($conexion, "utf8");
...
$consulta2="SELECT * FROM pedidosillon WHERE  Estado_PedidoSillon ='i';";
mysqli_set_charset($conexion, "utf8");
