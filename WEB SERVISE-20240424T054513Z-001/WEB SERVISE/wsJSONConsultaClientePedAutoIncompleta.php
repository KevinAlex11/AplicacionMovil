...
$consulta="SELECT * FROM pedidoauto WHERE Id_Cliente='{$id_Cliente}' AND Id_Negocio='{$id_Negocio}' AND Estado_PedidoAuto ='i';";
...
$consulta1="SELECT * FROM pedidocolchon WHERE Id_Cliente='{$id_Cliente}' AND Id_Negocio='{$id_Negocio}' AND Estado_PedidoCol ='i';";
mysqli_set_charset($conexion, "utf8");
...
$consulta2="SELECT * FROM pedidosillon WHERE Id_Cliente='{$id_Cliente}' AND Id_Negocio='{$id_Negocio}' AND Estado_PedidoSillon ='i';";
mysqli_set_charset($conexion, "utf8");
