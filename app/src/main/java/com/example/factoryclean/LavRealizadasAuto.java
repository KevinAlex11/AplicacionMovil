...
public class LavRealizadasAuto extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipoLav.add("Colchon");
        tipoLav.add("Sillon");
        ArrayAdapter adpr=new ArrayAdapter(LavRealizadasAuto.this,android.R.layout.simple_spinner_dropdown_item,tipoLav);
        tipor.setAdapter(adpr);
        //Seleccion del item por la posicion
        tipor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {

            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                lav=(String)tipor.getAdapter().getItem(position);
    ...
    public void cargarwsR(){
        //Para mandar los datos hacia la base de datos
        String url="http://proyectosinformaticatnl.ceti.mx/whoclean/wsJSONConsultaClientePedAutoRealizada.php?Id_Cliente="+idC+"&Id_Negocio="+idN;
        url=url.replace(" ","%20");
        jsonObjectRequest=new JsonObjectRequest(Request.Method.GET,url,null,this, this);
        request.add(jsonObjectRequest);
    }
    public void cargarwsRN(){
        //Para mandar los datos hacia la base de datos
        String url="http://proyectosinformaticatnl.ceti.mx/whoclean/wsJSONConsultaClienteInfoRealizadas.php";
        url=url.replace(" ","%20");
        jsonObjectRequest=new JsonObjectRequest(Request.Method.GET,url,null,this, this);
        request.add(jsonObjectRequest);
    }
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            for(int i=0;i<json.length();i++){
                ...
                lavAutoC.setId_PedidoAuto(jsonObject.optInt("Id_Pedido"));
        ...
        try {
            for (int e = 0; e < json1.length(); e++) {
                ...
                lavColC.setId_PedidoColchon(jsonObjectc.optInt("Id_Pedido"));
    ...
    public void clienteLavAuto(){
        Intent siguiente=new Intent(this, Info_Lavadas.class);
        Bundle bundle=new Bundle();
        bundle.putSerializable("cliente",cliente);
        bundle.putSerializable("id",ida);
        bundle.putSerializable("id",ids);
        bundle.putSerializable("id",idc);
