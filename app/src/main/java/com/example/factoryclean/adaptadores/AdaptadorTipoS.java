...
public class AdaptadorTipoS extends RecyclerView.Adapter<AdaptadorTipoS.ViewHolderDatos> implements View.OnClickListener {
    @NonNull
    ArrayList<tipoSill> listaTipoS;
    private View.OnClickListener listener;
    RequestQueue request;
    Context context;

    public AdaptadorTipoS(@NonNull ArrayList<tipoSill> listaTipoS, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderDatos holder, int position) {
        holder.etiquetaTipo.setText(listaTipoS.get(position).getTipoSillon());
        holder.etiquetaDesctipo.setText(listaTipoS.get(position).getDescTipoSillon());
        if (listaTipoS.get(position).getImagenTipoSillon() != null) {
            cargarImage(listaTipoS.get(position).getImagenTipoSillon(), holder);
        } else {
    ...
    private void cargarImage(String imagen, final AdaptadorTipoS.ViewHolderDatos holder) {
